...
public class BTreeInternalPageTest extends SimpleDbTestBase {
    ...
    public static final int[][] EXAMPLE_VALUES = new int[][]{{2, 6350, 4}, {4, 9086, 5}, {5, 17197, 7}, {7, 22064, 9}, {9, 22189, 10}, {10, 28617, 11}, {11, 31933, 13}, {13, 33549, 14}, {14, 34784, 15}, {15, 42878, 17}, {17, 45569, 19}, {19, 56462, 20}, {20, 62778, 21}, {15, 42812, 16}, {2, 3596, 3}, {6, 17876, 7}, {1, 1468, 2}, {11, 29402, 12}, {18, 51440, 19}, {7, 19209, 8}};
    ...
    static {
        ...
        try {
            EXAMPLE_DATA = BTreeFileEncoder.convertToInternalPage(entries, BufferPool.getPageSize(), Type.INT_TYPE, BTreePageId.LEAF);
        } catch (IOException e) {
    ...
    public void addEntry() throws Exception {
        ...
        for (int i = 0; i < free; ++i) {
            ...
            while (it.hasNext()) {
                BTreeEntry e = it.next();
                if (e.getKey().equals(addition.getKey()) && e.getLeftChild().equals(addition.getLeftChild()) && e.getRightChild().equals(addition.getRightChild())) {
                    found = true;
