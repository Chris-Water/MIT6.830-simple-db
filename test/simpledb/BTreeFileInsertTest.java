...
public class BTreeFileInsertTest extends SimpleDbTestBase {
    ...
    public void testSplitLeafPages() throws Exception {
        ...
        assertTrue(BTreeUtility.getNumTuplesPerPage(2) / 2 == page.getNumTuples() || BTreeUtility.getNumTuplesPerPage(2) / 2 + 1 == page.getNumTuples());
        assertTrue(BTreeUtility.getNumTuplesPerPage(2) / 2 == otherPage.getNumTuples() || BTreeUtility.getNumTuplesPerPage(2) / 2 + 1 == otherPage.getNumTuples());
    ...
    public void testSplitInternalPages() throws Exception {
        ...
        BTreeInternalPage leftPage = BTreeUtility.createRandomInternalPage(leftPageId, keyField, BTreePageId.LEAF, 0, BTreeUtility.MAX_RAND_VALUE, 3);
