...
public class TupleDesc implements Serializable {
    ...
    public String getFieldName(int i) throws NoSuchElementException {
        // some code goes here
        if (i < 0 || i >= tdItems.size()) throw new NoSuchElementException("invalid field reference");
    ...
    public int fieldNameToIndex(String name) throws NoSuchElementException {
        if (name == null) throw new NoSuchElementException("not a valid field name");
        // some code goes here
        int idx = -1;
        ...
        if (idx == -1) throw new NoSuchElementException("no field with a matching name is found");
        return idx;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (target.numFields() != this.numFields()) return false;
        for (int i = 0; i < tdItems.size(); i++) {
            if (!tdItems.get(i).fieldType.equals(target.getFieldType(i))) return false;
        }
        return true;
    }
