...
public interface DbFile {
  ...
  /**
   * Returns an iterator over all the tuples stored in this DbFile. The iterator must use
   * {@link BufferPool#getPage}, rather than {@link #readPage} to iterate through the pages.
   *
  ...
  /**
   * Returns number of pages in File
   *
