...
public class Aggregate extends Operator {
   ...
   * {@link IntegerAggregator} or {@link StringAggregator} to help you with your implementation of
   * readNext().
   *
  ...
  public Aggregate(OpIterator child, int afield, int gfield, Aggregator.Op aop) {
    ...
    aggregator = afieldType == Type.INT_TYPE ? new IntegerAggregator(gfield, gfieldType, afield, op)
        : new StringAggregator(gfield, gfieldType, afield, op);
    //构造tupleDesc
  ...
  public String groupFieldName() {
    // some code goes here
    return groupingField == Aggregator.NO_GROUPING ? null
        : child.getTupleDesc().getFieldName(groupingField);
  }
