...
//    private Query owner;
   ...
   * {@link Catalog#getDatabaseFile(int)}). Aliases are added as base tables are added via
   * {@link #addScan}.
   *
  ...
  public OpIterator physicalPlan(TransactionId t, Map<String, TableStats> baseTableStats,
    ...
    for (LogicalJoinNode lj : joins) {
      ...
      if (!isSubqueryJoin) {
        ...
        equivMap.put(t2name,
            t1name);  //keep track of the fact that this new node contains both tables
